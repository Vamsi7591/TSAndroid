...
public final class User_Table extends ModelAdapter<User> {
  ...
  public static final Property<String> password = new Property<String>(User.class, "password");
  ...
  public static final IProperty[] ALL_COLUMN_PROPERTIES = new IProperty[]{adminempcode,empName,empEmailid,password,empRole,empCode,date,projectName};
  ...
  public final void bindToInsertValues(ContentValues values, User model) {
    ...
    values.put("`password`", model.password != null ? model.password : null);
  ...
  public final String getCompiledStatementQuery() {
    return "INSERT INTO `user`(`adminempcode`,`empName`,`empEmailid`,`password`,`empRole`,`empCode`,`date`,`projectName`) VALUES (?,?,?,?,?,?,?,?)";
  }

  @Override
  public final String getUpdateStatementQuery() {
    return "UPDATE `user` SET `adminempcode`=?,`empName`=?,`empEmailid`=?,`password`=?,`empRole`=?,`empCode`=?,`date`=?,`projectName`=? WHERE `adminempcode`=?";
  }
  ...
  public final String getCreationQuery() {
    return "CREATE TABLE IF NOT EXISTS `user`(`adminempcode` TEXT, `empName` TEXT, `empEmailid` TEXT, `password` TEXT, `empRole` TEXT, `empCode` TEXT, `date` TEXT, `projectName` TEXT, PRIMARY KEY(`adminempcode`))";
  }
  ...
  public final void loadFromCursor(FlowCursor cursor, User model) {
    ...
    model.password = cursor.getStringOrDefault("password");
