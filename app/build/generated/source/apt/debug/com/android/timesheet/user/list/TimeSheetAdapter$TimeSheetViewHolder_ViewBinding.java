...
public class TimeSheetAdapter$TimeSheetViewHolder_ViewBinding implements Unbinder {
  private TimeSheetAdapter.TimeSheetViewHolder target;

  @UiThread
  public TimeSheetAdapter$TimeSheetViewHolder_ViewBinding(TimeSheetAdapter.TimeSheetViewHolder target,
      View source) {
    this.target = target;
    ...
    target.trashLL = Utils.findRequiredViewAsType(source, R.id.trash, "field 'trashLL'", LinearLayout.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    TimeSheetAdapter.TimeSheetViewHolder target = this.target;
