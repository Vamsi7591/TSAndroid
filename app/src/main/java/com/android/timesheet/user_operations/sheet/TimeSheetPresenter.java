package com.android.timesheet.user_operations.sheet;
...
import com.android.timesheet.user_operations.list.TimeSheetInteractor;
import com.android.timesheet.user_operations.list.TimeSheetRouter;
import com.android.timesheet.user_operations.list.TimeSheetViewBehaviour;
...
public class TimeSheetPresenter extends BasePresenter<TimeSheetViewBehaviour,
        com.android.timesheet.user_operations.list.TimeSheetInteractor, TimeSheetRouter> {
    ...
    @Override
    protected com.android.timesheet.user_operations.list.TimeSheetInteractor provideInteractor() {
