...
public class EditEmployeeInteractor extends BaseInteractor<EditEmployeeServices> {

    public EditEmployeeInteractor(Context context) {
        super(context);
    }

    @Override
    protected EditEmployeeServices provideService() {
        return new EditEmployeeServices();
    }
