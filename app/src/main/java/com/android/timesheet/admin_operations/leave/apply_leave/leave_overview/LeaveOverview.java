...
//        String fromDate, String toDate, String leaveType, String remarks, String empCode, String noOfDays
       /* leaveEntryList.add(new LeaveEntry("1-Jan-2018", "5-Jan-2018", Constant.CasualLeave, "My Brothers Marriage", "", "5", Constant.OnHold));
        leaveEntryList.add(new LeaveEntry("4-Feb-2018", "6-Feb-2018", Constant.CasualLeave, "Village Festival", "", "3", Constant.Rejected));
        leaveEntryList.add(new LeaveEntry("17-Mar-2018", "20-Mar-2018", Constant.SickLeave, "Fever", "", "4", Constant.Approved));
        leaveEntryList.add(new LeaveEntry("21-May-2018", "1-June-2018", Constant.EarnedLeave, "My Marriage", "", "10", Constant.OnHold));

        leaveEntryList.add(new LeaveEntry("1-Jan-2018", "5-Jan-2018", Constant.CasualLeave, "My Brothers Marriage", "", "5", Constant.Approved));
        leaveEntryList.add(new LeaveEntry("4-Feb-2018", "6-Feb-2018", Constant.EarnedLeave, "Village Festival", "", "3", Constant.Rejected));
        leaveEntryList.add(new LeaveEntry("17-Mar-2018", "20-Mar-2018", Constant.SickLeave, "Fever", "", "4", Constant.OnHold));
        leaveEntryList.add(new LeaveEntry("21-May-2018", "1-June-2018", Constant.CasualLeave, "My Marriage", "", "10", Constant.Approved));

        leaveEntryList.add(new LeaveEntry("1-Jan-2018", "5-Jan-2018", Constant.EarnedLeave, "My Brothers Marriage", "", "5", Constant.OnHold));
        leaveEntryList.add(new LeaveEntry("4-Feb-2018", "6-Feb-2018", Constant.CasualLeave, "Village Festival", "", "3", Constant.Approved));
        leaveEntryList.add(new LeaveEntry("17-Mar-2018", "20-Mar-2018", Constant.SickLeave, "Fever", "", "4", Constant.OnHold));
        leaveEntryList.add(new LeaveEntry("21-May-2018", "1-June-2018", Constant.EarnedLeave, "My Marriage", "", "10", Constant.Rejected));
*/
