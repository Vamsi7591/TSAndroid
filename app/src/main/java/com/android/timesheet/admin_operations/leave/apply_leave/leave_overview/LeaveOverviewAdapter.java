...
public class LeaveOverviewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LeaveOverviewAdapter(Context context, OnItemClickListener listener) {
