...
public class EditEmployeeMaster extends BaseActivity<EditEmployeeMasterPresenter>
    ...
    @Override
    protected EditEmployeeMasterPresenter providePresenter() {
        return new EditEmployeeMasterPresenter(this, this);
    }

    @Override
    protected int layoutRestID() {
        return R.layout.activity_edit_employee_master;
    }
    ...
    public boolean password() {
        if (passwordEt.getText().toString().length() < 6) {
            ...
            passwordTIL.setError("Password Length Error");
            return false;
        } else
