...
import com.android.timesheet.user.list.TimeSheetInteractor;
import com.android.timesheet.user.list.TimeSheetRouter;
...
public class TimeSheetPresenter extends BasePresenter<TimeSheetViewBehaviour, com.android.timesheet.user.list.TimeSheetInteractor, TimeSheetRouter> {
    ...
    @Override
    protected com.android.timesheet.user.list.TimeSheetInteractor provideInteractor() {
